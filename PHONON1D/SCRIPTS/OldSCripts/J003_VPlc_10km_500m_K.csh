...
# Runs on 6 cores on KEW 
# 1e7p x 4 cores x 8 iter = 3.2e8p
# Only 2 depths (20 & 1100)
# 2 freqs
# With TRACKING
# SL = 10km with ds = 500m
# Constant Qi = 7000
# Liquid outer core (from WEBER_2011)
...
set file_out   = "J003_VPlc_10km_500m_K"
set model_name = "VPREMOON_LIQc_Q7000_10km_500m"
...
# Output folder
set out_dir    = "/Volumes/JAG/jfguertin/OUTPUT"
set outTRACK_dir    = "/Volumes/JAG/jfguertin/TRACKING"
...
\rm /Volumes/JAG/jfguertin/OUTPUT/*.lpt
