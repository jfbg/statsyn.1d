...
set prob_scat  = 0.    # Scattering Layer scattering probability
...
echo "./bin/generatespikes << EOF"                         >  $file_csh
echo "$spikeloc"				                      >> $file_csh
