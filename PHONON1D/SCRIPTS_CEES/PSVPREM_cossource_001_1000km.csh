...
set dQdfstyle  = 3
set cossourcetype = 3    # delta (1), sine (2), custom (9)
set customcossourcefile = 'LP_0_01t0_5Hz_dt1s.cossource'
set rPrSVrSH   = "1 10 10"  # Energy partioning at cossource
set samtype    = 4   # Sampling over takeoff angles (1), or slownesses (2),or BM (3)
...
set file_out   = "PSVPREM_001_cossource"
...
echo "$cossourcetype        \!Source Type            "           >> $file_csh

if ($cossourcetype == 9) then
echo "SOURCES/$customcossourcefile"        >> $file_csh
endif
