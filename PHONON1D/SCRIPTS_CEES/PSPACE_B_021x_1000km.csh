...
set dsmin      = 3.4453   # Min scaterrer length scale
set dsmax      = 3.4453     # Max scaterrer length scale
set npow       = 0.   # Power law factor for scatterer lengthscale
set velperturb = 0.75

set file_out   = "PSPACE_B_021x"
set model_name = "CSIMPLEMOON_crust"
