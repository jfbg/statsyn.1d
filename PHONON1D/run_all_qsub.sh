...
sleep 1
qsub CEES_QSUB_SCRIPTS/qsub_PVPREM_001_07Hz_0000km_noscat.sh
sleep 1
qsub CEES_QSUB_SCRIPTS/qsub_PVPREM_001_07Hz_0030km_noscat.sh
sleep 1
qsub CEES_QSUB_SCRIPTS/qsub_PVPREM_001_07Hz_1000km_noscat.sh
sleep 1
