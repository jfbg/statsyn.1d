...
char *fwindow_name,*ficon_name;
{
	...
	unsigned int border_width = 0;	/* four pixels */
	...
	display_height = DisplayHeight(display, screen_num);
        *fwidth = display_width*.9;
        *fheight = display_height*.85;
...
float xrgb[100],ri[100],gi[100],bi[100]; long nrgb;





void linitrb_(xmn,xmx)
float *xmn,*xmx;
{

   nrgb = 3;
   xrgb[0] = *xmn; xrgb[1] = (*xmn+*xmx)/2.; xrgb[2] = *xmx;
   ri[0] = 65535.0; ri[1] = 65535.0; ri[2] =     0.0;
   gi[0] =     0.0; gi[1] = 65535.0; gi[2] =     0.0;
   bi[0] =     0.0; bi[1] = 65535.0; bi[2] = 65535.0;
...
double  *r, *g, *b;
{
   ...
   XSetForeground(display, usergc, cell.pixel);
}

void lgetcol_rb_(x,r,g,b,xmn,xmx)
float   *x,*xmn,*xmx;
double  *r,*g,*b;
{
   float anorm;
