...
C   | --- --------- --------- --------- --------- --------- --------- -- |   C
      IMPLICIT   NONE                            !ALLOW NO IMPLICIT VARIABLES
      REAL       w1(*),w2(*)                     !INPUT DATA SERIES
      COMPLEX    s1(131072),s2(131072)             !SPECTRA OF EACH SERIES
      COMPLEX    cohe(131072)                     !COHERENCE
      COMPLEX    tf12(131072),tf21(131072)         !TRANSFER FUNCTIONS
      INTEGER    npts,np2,nf                     !NUMBER OF DATA POINTS
      REAL       dt,df                           !TIME & FREQ SAMPLING INTERVALS
      INTEGER    I,J,K                           !STEP
      REAL       wl1,wl2,wl                      !WATER LEVELS
...
C   | --- --------- --------- --------- --------- --------- --------- -- |   C
      ...
      PARAMETER(   TSMX=262146,TSMX2=131073) !SET MAX AS PARAMETER
