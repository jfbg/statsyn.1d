...
set q_range    = "1371 1471 79"
#
# Set plot parameters
#
set SAT = "-.10 .10"
set FIG = "./FIGS_ATT"
set out_dir    = "./OUTPUT_ATT"
set SMOOTH = 0
...
$q_range                !ATTENUATION DEPTH RANGE AND VALUE
$out_dir/$file_out.$iii.core.300_400
EOF
...
# 
./bin/pstack2D << EOF
$out_dir/$file_out.$iii.core.300_400.LHZ
$SAT
$FIG/$file_out.$iii.core.300_400.LHZ.ps
0
0
0
$SMOOTH
EOF
gv $FIG/$file_out.$iii.core.300_400.LHZ.ps &
