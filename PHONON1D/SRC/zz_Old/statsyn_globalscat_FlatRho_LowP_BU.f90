...
!
! $Revision: 253 $
! $Date: 2012-11-29 08:58:29 -0800 (Thu, 29 Nov 2012) $
! $Author: jguertin $
!
!
!
...
!			^^^^^ DECLARATIONS ^^^^^
      ...
      write(*,*) 'Last Edited on $Date: 2012-11-29 08:58:29 -0800 (Thu, 29 Nov 2012) $'
      ...
      write(*,*) '*    IsoSourceEnergyPartition (1:1:1)'
      write(*,*) '*    Low take-off angles (< 60˚)'
      write(*,*) '*'
      write(*,*) '************************************'
      write(*,*) ''
