PROGRAM statsyn_bgscat
!
! There is a low probability of scattering anywhere in the interior.
!
...
!
! $Revision: 92 $
! $Date: 2012-07-20 16:21:31 -0700 (Fri, 20 Jul 2012) $
! $Author: jguertin $
!
!
...
!			^^^^^ DECLARATIONS ^^^^^
      ...
      write(*,*) 'Last Edited on $Date: 2012-07-20 16:21:31 -0700 (Fri, 20 Jul 2012) $'
