...
!
! $Revision: 1111 $
! $Date: 2014-07-31 14:40:02 -0700 (Thu, 31 Jul 2014) $
! $Author: jguertin $
!
!
!
...
!
! !!!!!!!!!!!!!!!!!!!!!!!!!!
! Look into the sharp rise in decay times at short epicentral distances
...
!      ^^^^^ DECLARATIONS ^^^^^
      ...
      WRITE(*,*) 'Last Edited on $Date: 2014-07-31 14:40:02 -0700 (Thu, 31 Jul 2014) $'
...
!      ^^^^^ GET INPUTS ^^^^^
      ...
      OPEN(7770,FILE='Dist000.txt',STATUS='UNKNOWN')
      OPEN(7771,FILE='Dist002.txt',STATUS='UNKNOWN')
      OPEN(7772,FILE='Dist004.txt',STATUS='UNKNOWN')
      OPEN(7773,FILE='Dist006.txt',STATUS='UNKNOWN')
      OPEN(7774,FILE='Dist008.txt',STATUS='UNKNOWN')
      OPEN(7775,FILE='Dist010.txt',STATUS='UNKNOWN')
      OPEN(7776,FILE='Dist012.txt',STATUS='UNKNOWN')
      OPEN(7777,FILE='Dist014.txt',STATUS='UNKNOWN')
      OPEN(7778,FILE='Dist016.txt',STATUS='UNKNOWN')
      OPEN(7779,FILE='Dist018.txt',STATUS='UNKNOWN')
      OPEN(7780,FILE='Dist020.txt',STATUS='UNKNOWN')
      OPEN(7781,FILE='Dist030.txt',STATUS='UNKNOWN')
      OPEN(7782,FILE='Dist040.txt',STATUS='UNKNOWN')
      OPEN(7783,FILE='Dist050.txt',STATUS='UNKNOWN')
      OPEN(7784,FILE='Dist060.txt',STATUS='UNKNOWN')
      OPEN(7785,FILE='Dist070.txt',STATUS='UNKNOWN')
      OPEN(7786,FILE='Dist080.txt',STATUS='UNKNOWN')
      OPEN(7787,FILE='Dist090.txt',STATUS='UNKNOWN')
...
!       WRITE(6,*) '       Params:',tt2-tt1,I,t,z_act     
       ...
       IF (z_act > maxdepth) maxdepth = z_act
       z_last = z_act
