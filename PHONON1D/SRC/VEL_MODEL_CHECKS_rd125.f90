      ...
      !MODEL CHECKS
			...
			! DRECEIVER IS DIFFERENT! USE TO TEST EFFECT OF VARIOUS DRECEIVER VALUES ON DATA
      dreceiver_km = 1.25  !radius around receiver in which the phonons will be recorded (km)
